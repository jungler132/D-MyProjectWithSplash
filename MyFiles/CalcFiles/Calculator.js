            ...
            <View style={{flex:1}}>
                ...
                <View style={styles.buttonScreen}>
                    <View style={styles.buttonView}>
                        <TouchableOpacity onPress={() => this.calculatedResult("", this.answerResult)} style={styles.touchOpButton}>
                            <Text style={styles.buttonInsideText}>
                                =
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.functionPlusMinus()} style={styles.touchOpButton}>
                            <Text style={styles.buttonInsideText}>
                                +-
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.functionClear("", this.answerResult)} style={styles.touchOpButton}>
                            <Text style={styles.buttonInsideText}>
                                C
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.dotButtonFunc(".")} style={styles.touchOpButton}>
                            <Text style={styles.buttonInsideText}>
                                .
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.functionDeleteOneChar("", this.answerResult)} style={styles.touchOpButton}>
                            <Text style={styles.buttonInsideText}>
                                Del
                            </Text>
                        </TouchableOpacity>
                    ...
                    <View style={styles.numberButtons}>
                        <View style={styles.numberButtonStyle}>
                            {this.arrayNumber.map((item , index) => {
                                return (
                                    <TouchableOpacity key={index} onPress={() => this.functionPress(item , this.answerNumber)} style={styles.numberButtonStyleOne}>
                                        <Text style={styles.numberButtonTextStyle}>
                                            {item}
                                        </Text>
                                    </TouchableOpacity>
                                );
                        ...
                        <View style={styles.operationButtonViewStyle}>
                        <TouchableOpacity onPress={() => this.funcOperations("+" , this.answerResult)} style={styles.operationsButtonStyleOne}>
                            <Text style={styles.operationButtonTextStyle}>
                                +
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.funcOperations("-" , this.answerResult)} style={styles.operationsButtonStyleOne}>
                    ...
                    <TouchableOpacity onPress={() => this.functionPress("0", this.answerResult)} style={styles.zeroButtonStyle}>
                    <Text style={styles.numberButtonTextStyle}>
                        0
                    </Text>
                </TouchableOpacity>
